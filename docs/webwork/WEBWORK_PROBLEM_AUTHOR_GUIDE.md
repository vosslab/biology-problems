...
- ADAPT does not render HTML or numeric Unicode entities in BEGIN_PGML_SOLUTION; keep solution text plain ASCII when exporting to ADAPT (for example, avoid `CH&#8322;CH&#8322;` in solutions).
