...
if __name__ == '__main__':
	...
	sugars = []
	sugars += sugar_codes_class.get_sugar_names(7, 'D', 'keto')
	sugars += sugar_codes_class.get_sugar_names(7, 'L', 'keto')
	...
	f = open('bbq-monosaccharide_Haworth_pyran_classification.txt', 'w')
