...
def build_solution_text():
	...
	text += "# Solution\n"
	text += "# -------------------------------\n"
	text += "$answer_list = join(', ', map { ($_ + 1) . '-' . $ALPHABET[$answer_index{$q_and_a[$_][1]}] } 0 .. $#q_and_a);\n"
	text += "BEGIN_PGML_SOLUTION\n"
	text += "The correct answers are: [$answer_list].\n"
