...
$true_false = select_one_element(
  '<span style="color: #ba372a;"><strong>FALSE</strong></span>',
  '<span style="color: #169179;"><strong>TRUE</strong></span>',
  );
...
BEGIN_TEXT
Which one of the following statements is $true_false $connecting_word $topic?
$BR
\{ $radio->buttons() \}
END_TEXT
