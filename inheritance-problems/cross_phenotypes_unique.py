...
if __name__ == '__main__':
	...
	for i in range(num_questions):
		...
		number = "{0}. ".format(N)
		question = ""
		question += '<p>How many unique <span style="color: OrangeRed;"><strong>PHENOTYPES</strong></span> '
		question += 'could be produced through hybrid cross between the following individuals?</p> <ul> '
		gamete_count1 = 1
		...
		question += "</ul>"
		question += "Assume the all of the genes display complete dominance."
