...
def test_protein_ladder_lib_calculate_mw_gaps_smoke():
	mod = import_from_repo_path("problems/biochemistry-problems/protein_ladder_lib.py")
...
def test_kaleidoscope_ladder_mapping_prelim_question_builds_expected_parts(monkeypatch):
	mod = import_from_repo_path("problems/biochemistry-problems/kaleidoscope_ladder_mapping.py")
