...
def test_pedigree_graph_parse_lib_compile_to_valid_code():
	...
	pedigree_validate_lib = import_from_repo_path("inheritance-problems/pedigrees/pedigree_validate_lib.py")

	rng = random.Random(1)
	pedigree_dir = os.path.join(repo_root(), "inheritance-problems", "pedigrees")
